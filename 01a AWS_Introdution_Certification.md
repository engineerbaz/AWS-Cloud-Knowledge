...
## Free Tier 
With a free tier account, you get access to over 75 AWS products, including some of the most widely used services such as EC2, and S3.
...
Services will be expired after trial ends, but some services do not expire 
- DynamoDB
- Code Commit, Build, PipeLine
- X-Ray 
- Storage GW
- SWF
- Lambda
...
[Always Free AWS Services ](https://aws.amazon.com/free/?awsf.Free%20Tier%20Types=tier%23always-free&all-free-tier.sort-by=item.additionalFields.SortRank&all-free-tier.sort-order=asc)
...
1. Foundational (Costs $100) 90 minutes & 65 Questions , Requires 6 month Experience 
   1. Cloud Practioner
2. Associate (Costs $150) 130 minutes & 65 Questions , Requires 12 month Experience 
   1. Solution Architect
   2. SysOps Administrator
   3. Developer
3. Professional (Costs 300$) 170 minutes and 75 questions,  Requires 24 month Experience 
   1. Solution Architect
   2. DevOps Engineer
